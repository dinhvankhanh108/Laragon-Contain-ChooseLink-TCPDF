...
<table class="content__table" style="width:100%">
							...
							<tr>
								<td class="content__table--spacing">&nbsp;</td>
								<td class="content__table--auto">&nbsp;</td>
							</tr>
						</table>';
...
$pdf->writeHTMLCell('20', '', 170, 65, $right_column1, 0, 0, 0, true, 'C', true);
...
$footer21_img = "<img src=\"images/sorimachi_kabu_logo.png\" alt=\"test alt attribute\" width=\"150\" height=\"30\" border=\"0\"/>";
...
';
// $pdf->writeHTMLCell('', '', 60, 100, $footer21_img, 1, 2, 0, true, 'L', true);
$pdf->writeHTMLCell(100, 20, 60, 100, $footer21, 0, 0, 0, true, 'L', true);
$pdf->writeHTMLCell('', '', 70, 115, $footer22, 0, 0, 0, true, 'L', true);
